...
export const Carousel = () => {
  ...
  return (
    <div className="flex flex-col items-center -mt-12 pl-[74px]">
      <div
        className="flex space-x-4 w-[450px]  pb-8 px-20 overflow-scroll snap-x scroll-smooth scroll-proximity snap-mandatory cursor-grab md:scrollbar-none"
        ref={carouselRef}
      >
      ...
      <div className="flex  items-center space-x-2 pt-2 -ml-[20%] md:ml-0">
        <ScrollControlButton
          snapPoint={0}
