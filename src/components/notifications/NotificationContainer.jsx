...
export const NotificationContainer = ({padding,setShowNotifications}) => 
{
  const notifications =[{_id:"1",icon:"🎨",imgLink:"",content:`Don't forget about the 'Weekly Code Jam' event in the 'Coding Wizards' community. It starts in 1 hour!`},
  {_id:"2",icon:"🌆",imgLink:"https://i.pinimg.com/originals/d2/7f/0e/d27f0e48251435cb1ca1c45f2b005eec.jpg",content:"Hange Zoe sent you a Friend Request"}]

  return (
    <div className={`flex flex-col gap-5 pt-12 pb-4 px-8 bg-background rounded-b-[30px] `}>
      <header className='flex justify-between items-center relative mb-4'>
        <h1 className='text-2xl font-bold '>Notifications</h1>
        
        <span className='flex justify-center absolute items-center right-0 bg-white -mr-[15px] w-14 h-14 rounded-3xl' onClick={()=>setShowNotifications(false)}>
